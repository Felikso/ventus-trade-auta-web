 ...
 */
const BackgroundCustomedSlider = ({callbacks, images, duration, transition, initDelay, query, children, ...gatsbyImageProps}) => {	
	let nodes = [];
	let bgRefs = [];
	let subRefs = [];	
	let bgWrappers = [];
...
BackgroundCustomedSlider.defaultProps = {
	images: null,
	duration: 5,
	transition: 2,
	initDelay: 5,
...
BackgroundCustomedSlider.propTypes = {
...
export default BackgroundCustomedSlider
